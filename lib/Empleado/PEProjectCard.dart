import 'package:chatempresa/Empleado/PESubtareasScreen.dart';
import 'package:chatempresa/modelo/Proyecto.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class PEProjectCard extends StatelessWidget {
  final Proyecto project;

  const PEProjectCard({super.key, required this.project});
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PESubtareasScreen(
